...
import (
	...
	istanbulBackend "github.com/galaxy/galaxy-eth/consensus/istanbul/backend"
	"github.com/galaxy/galaxy-eth/core"
	"github.com/galaxy/galaxy-eth/core/bloombits"
	...
	"github.com/galaxy/galaxy-eth/eth/filters"
	...
	"github.com/galaxy/galaxy-eth/miner"
...
func CreateConsensusEngine(ctx *node.ServiceContext, chainConfig *params.ChainConfig, config *Config, notify []string,
