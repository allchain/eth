...
[![Travis](https://travis-ci.org/galaxy/galaxy.svg?branch=master)](https://travis-ci.org/galaxy/galaxy)
...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/galaxy/galaxy-eth

    go install github.com/galaxy/galaxy-eth/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/galaxy/galaxy-eth`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/galaxy/galaxy-eth
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/galaxy/galaxy-eth/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/galaxy/galaxy-eth/wiki/Code-Review-Guidelines).
